...
import { TeamLeaderSelection } from './components/AttendantSelection';
import { ReportsList } from './components/ReportsList';
import type { FormData, Report, TeamLeader, Offence, OffenderInfo, CurrencyDetail } from './types';
            ...
            if (key === 'offence') {
                ...
                if (offender.offence.includes('ATTEMPTING TO CORRUPT MARSHAL')) {
                    if (offender.currencyDetails.length === 0) {
                        // This case should be handled by the logic, but as a fallback
                        isFormValid = false; 
                    }
